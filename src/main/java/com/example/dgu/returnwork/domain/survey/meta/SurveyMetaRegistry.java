...
public final class SurveyMetaRegistry {
    ...
    public static final List<SurveyQuestionMeta> Q = List.of(
            ...
            new SurveyQuestionMeta(3, "하루에 몇 kg까지 반복적으로 들 수 있나요?",
                    "반복 들기(kg)", "strength", "physical", 1, 5, 1.2),
            new SurveyQuestionMeta(4, "손가락을 이용한 세밀한 작업(나사 조립, 글씨쓰기 등)을 얼마나 잘 수행할 수 있나요?",
                    "손 정밀도", "fine_motor", "motor", 1, 5, 1.3),
            new SurveyQuestionMeta(5, "다른 사람과 협력하여 작업할 때 불편함은 어느 정도인가요?",
            ...
            new SurveyQuestionMeta(8, "소음, 빛, 반복 동작 등 작업 환경에서 스트레스를 견디는 정도는 어떤가요?",
            ...
            new SurveyQuestionMeta(10, "사고 이후 본인의 자신감/사회적 활동 의지가 어느 정도인가요?",
